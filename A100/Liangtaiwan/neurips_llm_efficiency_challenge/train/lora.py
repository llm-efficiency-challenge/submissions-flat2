...
max_iters = 500000  # train dataset size
weight_decay = 0.01
lora_r = 8
lora_alpha = 16
lora_dropout = 0.05
...
def setup(
    ...
    fabric.launch(main, data_dir, checkpoint_dir, out_dir, model_name, quantize)


def main(fabric: L.Fabric, data_dir: Path, checkpoint_dir: Path, out_dir: Path, model_name: Optional[str] = None, quantize: Optional[str] = None) -> None:
