...
checkpoint_dir = Path("/scratch/acf15860xt/output/lora_merged/llama-2-13b-qlora-instruct")
# checkpoint_dir = Path("/scratch/acf15860xt/LLama-2-13b-hf")
# checkpoint_dir = Path("/scratch/acf15860xt/checkpoints/mistralai/Mistral-7B-v0.1")
