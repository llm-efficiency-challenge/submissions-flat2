...
# Hyperparameters
grad_max_norm = 0.3  # try with and without clipping max_grad_norm 0.3
learning_rate = 3e-4  # try 2e-4
batch_size = 128
micro_batch_size = 4
...
lora_r = 8  # 8, 16, 32, 64
lora_alpha = 16
lora_dropout = 0.05  # try 0.05 and 0.1
lora_query = True  # True
lora_key = False  # True
lora_value = True  # True
...
def setup(
    ...
    out_dir: Path = Path("out/lora/oasst1"),
...
def train(
    ...
    for iter_num in range(max_iters):
        ...
        input_ids, targets = get_batch(
            fabric, train_data, longest_seq_ix if iter_num == 0 else None
        )
