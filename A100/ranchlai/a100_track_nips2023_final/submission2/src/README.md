...
# /mnt/data3/kl/checkpoint-6500

docker run --gpus "device=0" -p 8080:80 -v /mnt/data3/kl/llama2-70B-gptq-4bit-v1:/workspace/llama2-70b-gptq-4bit -v /root/code/nips2023_final/eval/checkpoints/llama2-70B-gptq-4bit-v11-wd0.3/checkpoint-9000:/workspace/llama2-lora-2 --rm -ti llama_recipes_inference


# docker run --gpus "device=0" -p 8080:80 -v /mnt/data3/kl/llama2-70B-gptq-4bit-v1:/workspace/llama2-70b-gptq-4bit --rm -ti llama_recipes_inference
