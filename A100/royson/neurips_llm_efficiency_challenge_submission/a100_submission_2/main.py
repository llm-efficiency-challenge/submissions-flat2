...
from lit_gpt.utils import load_checkpoint, gptq_quantization
...
quantize = None
checkpoint_dir = Path("out/lora_merged/final_model")
...
fabric = L.Fabric(devices=1, accelerator="cuda", precision=precision, plugins=plugins)

with open(checkpoint_dir / "lit_config.json") as fp:
    config = Config(**json.load(fp))

checkpoint_path = checkpoint_dir / "lit_model.pth"
# checkpoint_path = "out/Llama-2-7b-chat-hf/lit_model_lora_finetuned.pth"

## combine with lora weights
