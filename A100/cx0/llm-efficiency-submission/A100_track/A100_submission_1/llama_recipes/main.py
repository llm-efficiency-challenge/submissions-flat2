...
model = AutoModelForCausalLM.from_pretrained("onuralp/Llama-2-13b-QLoRA-01-merged", device_map="auto").eval()
tokenizer = AutoTokenizer.from_pretrained("onuralp/Llama-2-13b-QLoRA-01-merged")
