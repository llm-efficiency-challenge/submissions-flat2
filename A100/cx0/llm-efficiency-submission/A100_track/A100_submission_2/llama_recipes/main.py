...
model = AutoModelForCausalLM.from_pretrained("onuralp/Mistral-7B-v0.1-QLoRA-02-merged", device_map="auto").eval()
tokenizer = AutoTokenizer.from_pretrained("onuralp/Mistral-7B-v0.1-QLoRA-02-merged")
