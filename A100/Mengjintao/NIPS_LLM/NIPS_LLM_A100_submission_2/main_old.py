...
# model = LlamaForCausalLM.from_pretrained('meta-llama/Llama-2-7b-hf',return_dict=True,load_in_8bit=True,device_map="auto",low_cpu_mem_usage=True)
...
model = LlamaForCausalLM.from_pretrained('meta-llama/Llama-2-13b-hf',return_dict=True,quantization_config=quantization_config,device_map="cuda:0",trust_remote_code=True,use_flash_attention_2=True)
